...
export const expansions: Expansion[] = [
  ...
  { id: 'deadpool',           name: 'Deadpool (KS)',                    type: 'promo', parentId: 'deadpool' },
  { id: 'days-of-future-past',name: 'Days of Future Past',         type: 'promo', parentId: 'days-of-future-past' },
  { id: 'spider-verse',       name: 'Enter the Spider-Verse (KS)',      type: 'promo', parentId: 'spider-verse' },
  { id: 'guardians',          name: 'Guardians of the Galaxy (KS)',     type: 'promo', parentId: 'guardians' },
  { id: 'tales-of-asgard',    name: 'Tales of Asgard (KS)',             type: 'promo', parentId: 'tales-of-asgard' },
  { id: 'world-war-hulk',     name: 'World War Hulk (KS)',              type: 'promo', parentId: 'world-war-hulk' },
  { id: 'multiverse-core',    name: 'Multiverse Core Box (KS)',         type: 'promo', parentId: 'multiverse-core' },
  ...
  { id: 'xmen-blue',          name: 'X-Men: Blue Team (KS)',            type: 'promo', parentId: 'xmen-blue' },
  { id: 'xmen-gold',          name: 'X-Men: Gold Team (KS)',            type: 'promo', parentId: 'xmen-gold' },
  { id: 'xmen-core',          name: 'X-Men Core Box (KS)',              type: 'promo', parentId: 'xmen-core' },
