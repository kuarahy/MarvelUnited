...
export const villains: Character[] = [
  ...
  { id: 'pyro',                name: 'Pyro',               role: 'villain', expansionId: 'xmen-core-ks', ksExclusive: true, alsoIn: 'season-2-stretch-goals' },
  { id: 'toad',                name: 'Toad',               role: 'villain', expansionId: 'xmen-core-ks', ksExclusive: true, alsoIn: 'season-2-stretch-goals' },
  { id: 'blob',                name: 'Blob',               role: 'villain', expansionId: 'xmen-core-ks', ksExclusive: true, alsoIn: 'season-2-stretch-goals' },
