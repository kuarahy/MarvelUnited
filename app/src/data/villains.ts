...
export const villains: Character[] = [
  ...
  { id: 'pyro',                name: 'Pyro',               role: 'villain', expansionId: 'season-2-stretch-goals', ksExclusive: true},
  { id: 'toad',                name: 'Toad',               role: 'villain', expansionId: 'season-2-stretch-goals', ksExclusive: true },
  { id: 'blob',                name: 'Blob',               role: 'villain', expansionId: 'season-2-stretch-goals', ksExclusive: true },
